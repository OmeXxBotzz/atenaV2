...
`.trim()
  ...
  let buff = ('http://lolhuman.herokuapp.com/api/ktpmaker?apikey=929b48b9aa5a91abed8526cd&nik=' + nik + '&prov=' + prov + '&kabu=' + kabu + '&name=' + name + '&ttl=' + ttl + '&jk=' + jk + '&jl=' + jl + '&rtrw=' + rtrw + '&lurah=' + lurah + '&camat=' + camat + '&agama=' + agama + '&nikah=' + nikah + '&kerja=' + kerja + '&warga=' + warga + '&until=' + until + '&img=' + img);
